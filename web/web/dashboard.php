...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li><a href="vulnerabilities/Sql_injection.php">4. SQL Injection</a></li> 
            <li><a href="vulnerabilities/Broken_Authentication/index.php">5. Broken Authentication </a></li>
            <li><a href="vulnerabilities/File_upload.php">6. File Upload</a></li>
        </ul>
